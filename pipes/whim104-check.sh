...
#
# Runs after pipes/whim104-edit.sh and the sweep tools/phaserun.sh runs between them,
...
work=${1:?usage: whim104-check.sh <work-dir> <state-dir>}
state=${2:?usage: whim104-check.sh <work-dir> <state-dir>}
