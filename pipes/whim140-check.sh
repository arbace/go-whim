...
# See pipes/whim140-edit.sh, and WHIM-GOAL.md.
#
# Usage: pipes/whim140-check.sh <work-dir> <state-dir>    (run from the repository root)
#
...
work=${1:?usage: whim140-check.sh <work-dir> <state-dir>}
state=${2:?usage: whim140-check.sh <work-dir> <state-dir>}
