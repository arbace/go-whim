#!/bin/sh
# Whim phase 131 -- the saved input buffer is a garray_T *.  See WHIM-GOAL.md.
#
# Usage: pipes/whim131-edit.sh <work-dir> <state-dir>     (run from the repository root)
#
...
work=${1:?usage: whim131-edit.sh <work-dir> <state-dir>}
state=${2:?usage: whim131-edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
