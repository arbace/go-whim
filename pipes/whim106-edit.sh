...
# nobody expected it on, and pipes/whim106-check.sh builds the literal-unaware form as a
...
work=${1:?usage: whim106-edit.sh <work-dir> <state-dir>}
state=${2:?usage: whim106-edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs pipes/whim106-check.sh.
