#!/bin/sh
# Whim phase 154 -- the NULL write in free_one_termoption() is gone.  See WHIM-GOAL.md.
#
# Usage: pipes/whim154-edit.sh <work-dir> <state-dir>     (run from the repository root)
#
...
work=${1:?usage: whim154-edit.sh <work-dir> <state-dir>}
state=${2:?usage: whim154-edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
