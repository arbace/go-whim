#!/bin/sh
# Whim phase 132 -- nothing frees.  See WHIM-GOAL.md.
#
# Usage: pipes/whim132-edit.sh <work-dir> <state-dir>     (run from the repository root)
#
...
work=${1:?usage: whim132-edit.sh <work-dir> <state-dir>}
state=${2:?usage: whim132-edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
