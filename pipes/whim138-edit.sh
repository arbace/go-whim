#!/bin/sh
# Whim phase 138 -- no parameter carries an eval value.  See WHIM-GOAL.md.
#
# Usage: pipes/whim138-edit.sh <work-dir> <state-dir>     (run from the repository root)
#
...
work=${1:?usage: whim138-edit.sh <work-dir> <state-dir>}
state=${2:?usage: whim138-edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
