...
#
# Runs after pipes/whim121-edit.sh and the sweep tools/phaserun.sh runs between them,
...
work=${1:?usage: whim121-check.sh <work-dir> <state-dir>}
state=${2:?usage: whim121-check.sh <work-dir> <state-dir>}
