...
# tools/phasecheck.sh in pipes/whim91-check.sh is where "it compiles" is asserted.
#
...
# flags, exactly as pipes/whim85-edit.sh, whim87-edit.sh, whim88-edit.sh, whim89-edit.sh
# and whim90-edit.sh do it.  THE CORPUS SEES TWO CASES OF THIS PHASE and neither of
...
work=${1:?usage: whim91-edit.sh <work-dir> <state-dir>}
state=${2:?usage: whim91-edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs pipes/whim91-check.sh.
