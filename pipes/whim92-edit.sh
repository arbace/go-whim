...
# because it IS that, no behavioural probe can see it.  pipes/whim92-check.sh says
...
# flags, exactly as pipes/whim85-edit.sh and whim87- through whim91-edit.sh do it, and
...
work=${1:?usage: whim92-edit.sh <work-dir> <state-dir>}
state=${2:?usage: whim92-edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs pipes/whim92-check.sh.
