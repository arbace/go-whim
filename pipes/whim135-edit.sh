#!/bin/sh
# Whim phase 135 -- one regexp program type.  See WHIM-GOAL.md.
#
# Usage: pipes/whim135-edit.sh <work-dir> <state-dir>     (run from the repository root)
#
...
work=${1:?usage: whim135-edit.sh <work-dir> <state-dir>}
state=${2:?usage: whim135-edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
