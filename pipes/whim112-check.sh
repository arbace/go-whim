...
#
# Runs after pipes/whim112-edit.sh and the sweep tools/phaserun.sh runs between them,
...
work=${1:?usage: whim112-check.sh <work-dir> <state-dir>}
state=${2:?usage: whim112-check.sh <work-dir> <state-dir>}
