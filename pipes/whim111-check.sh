...
#
# Runs after pipes/whim111-edit.sh and the sweep tools/phaserun.sh runs between them, and
...
# monotonic one is 32-bit arithmetic, and pipes/whim111-edit.sh states it.
...
work=${1:?usage: whim111-check.sh <work-dir> <state-dir>}
state=${2:?usage: whim111-check.sh <work-dir> <state-dir>}
