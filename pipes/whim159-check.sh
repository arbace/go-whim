...
# See pipes/whim159-edit.sh, and WHIM-GOAL.md.
#
# Usage: pipes/whim159-check.sh <work-dir> <state-dir>    (run from the repository root)
#
...
work=${1:?usage: whim159-check.sh <work-dir> <state-dir>}
state=${2:?usage: whim159-check.sh <work-dir> <state-dir>}
