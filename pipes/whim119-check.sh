...
#
# Runs after pipes/whim119-edit.sh and the sweep tools/phaserun.sh runs between them, and
...
work=${1:?usage: whim119-check.sh <work-dir> <state-dir>}
state=${2:?usage: whim119-check.sh <work-dir> <state-dir>}
