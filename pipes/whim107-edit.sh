...
work=${1:?usage: whim107-edit.sh <work-dir> <state-dir>}
state=${2:?usage: whim107-edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs pipes/whim107-check.sh.
