...
work=${1:?usage: whim96-edit.sh <work-dir> <state-dir>}
state=${2:?usage: whim96-edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs pipes/whim96-check.sh.
