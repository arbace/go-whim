...
#      to take -- exactly as pipes/whim90-edit.sh says of its own, and that is stated
...
work=${1:?usage: whim94-edit.sh <work-dir> <state-dir>}
state=${2:?usage: whim94-edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs pipes/whim94-check.sh.
