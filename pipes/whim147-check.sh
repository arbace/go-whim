...
# See pipes/whim147-edit.sh, and WHIM-GOAL.md.
#
# Usage: pipes/whim147-check.sh <work-dir> <state-dir>    (run from the repository root)
#
...
work=${1:?usage: whim147-check.sh <work-dir> <state-dir>}
state=${2:?usage: whim147-check.sh <work-dir> <state-dir>}
