...
# both, and pipes/whim88-check.sh compares the DWARF enumerator values of the binary
...
# flags, exactly as pipes/whim85-edit.sh and pipes/whim87-edit.sh do it: the check
...
work=${1:?usage: whim88-edit.sh <work-dir> <state-dir>}
state=${2:?usage: whim88-edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# NOT create_cmdidxs --check, for pipes/whim85-edit.sh's reason: the derived
...
# tools/phaserun.sh sweeps next, then runs pipes/whim88-check.sh.
