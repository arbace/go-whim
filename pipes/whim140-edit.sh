#!/bin/sh
# Whim phase 140 -- highlight groups are found in their array.  See WHIM-GOAL.md.
#
# Usage: pipes/whim140-edit.sh <work-dir> <state-dir>     (run from the repository root)
#
...
work=${1:?usage: whim140-edit.sh <work-dir> <state-dir>}
state=${2:?usage: whim140-edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
