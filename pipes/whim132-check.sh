...
# See pipes/whim132-edit.sh, and WHIM-GOAL.md.
#
# Usage: pipes/whim132-check.sh <work-dir> <state-dir>    (run from the repository root)
#
...
work=${1:?usage: whim132-check.sh <work-dir> <state-dir>}
state=${2:?usage: whim132-check.sh <work-dir> <state-dir>}
