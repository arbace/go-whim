...
# See pipes/whim144-edit.sh, and WHIM-GOAL.md.
#
# Usage: pipes/whim144-check.sh <work-dir> <state-dir>    (run from the repository root)
#
...
work=${1:?usage: whim144-check.sh <work-dir> <state-dir>}
state=${2:?usage: whim144-check.sh <work-dir> <state-dir>}
