...
# this edit does, and what pipes/whim112-check.sh then does again from this machine's
...
work=${1:?usage: whim112-edit.sh <work-dir> <state-dir>}
state=${2:?usage: whim112-edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs pipes/whim112-check.sh.
