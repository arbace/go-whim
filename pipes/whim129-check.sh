...
# See pipes/whim129-edit.sh, and WHIM-GOAL.md.
#
# Usage: pipes/whim129-check.sh <work-dir> <state-dir>    (run from the repository root)
#
...
# it -- no case types an emoji -- and moves nothing (pipes/zero.delta declares
...
work=${1:?usage: whim129-check.sh <work-dir> <state-dir>}
state=${2:?usage: whim129-check.sh <work-dir> <state-dir>}
