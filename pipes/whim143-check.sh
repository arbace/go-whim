...
# See pipes/whim143-edit.sh, and WHIM-GOAL.md.
#
# Usage: pipes/whim143-check.sh <work-dir> <state-dir>    (run from the repository root)
#
...
work=${1:?usage: whim143-check.sh <work-dir> <state-dir>}
state=${2:?usage: whim143-check.sh <work-dir> <state-dir>}
