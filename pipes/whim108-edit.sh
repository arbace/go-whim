...
# it must print `main` alone.  pipes/whim108-check.sh builds both variants.
#
...
work=${1:?usage: whim108-edit.sh <work-dir> <state-dir>}
state=${2:?usage: whim108-edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs pipes/whim108-check.sh.
