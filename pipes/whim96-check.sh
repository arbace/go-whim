...
#
# Runs after pipes/whim96-edit.sh and the sweep tools/phaserun.sh runs between them,
...
work=${1:?usage: whim96-check.sh <work-dir> <state-dir>}
state=${2:?usage: whim96-check.sh <work-dir> <state-dir>}
