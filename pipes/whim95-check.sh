...
#
# Runs after pipes/whim95-edit.sh and the sweep tools/phaserun.sh runs between them,
...
work=${1:?usage: whim95-check.sh <work-dir> <state-dir>}
state=${2:?usage: whim95-check.sh <work-dir> <state-dir>}
