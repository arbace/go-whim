#!/bin/sh
# Whim phase 151 -- the option table's defaults are typed.  See WHIM-GOAL.md.
#
# Usage: pipes/whim151-edit.sh <work-dir> <state-dir>     (run from the repository root)
#
...
work=${1:?usage: whim151-edit.sh <work-dir> <state-dir>}
state=${2:?usage: whim151-edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
