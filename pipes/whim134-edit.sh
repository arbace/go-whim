#!/bin/sh
# Whim phase 134 -- the empty blocks fold.  See WHIM-GOAL.md.
#
# Usage: pipes/whim134-edit.sh <work-dir> <state-dir>     (run from the repository root)
#
...
work=${1:?usage: whim134-edit.sh <work-dir> <state-dir>}
state=${2:?usage: whim134-edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
