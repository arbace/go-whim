...
#
# Runs after pipes/whim87-edit.sh and the sweep tools/phaserun.sh runs between them,
...
work=${1:?usage: whim87-check.sh <work-dir> <state-dir>}
state=${2:?usage: whim87-check.sh <work-dir> <state-dir>}
