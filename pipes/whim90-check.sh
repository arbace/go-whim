...
#
# Runs after pipes/whim90-edit.sh and the sweep tools/phaserun.sh runs between them,
...
work=${1:?usage: whim90-check.sh <work-dir> <state-dir>}
state=${2:?usage: whim90-check.sh <work-dir> <state-dir>}
