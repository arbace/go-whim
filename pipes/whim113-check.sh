...
#
# Runs after pipes/whim113-edit.sh and the sweep tools/phaserun.sh runs between them,
...
work=${1:?usage: whim113-check.sh <work-dir> <state-dir>}
state=${2:?usage: whim113-check.sh <work-dir> <state-dir>}
