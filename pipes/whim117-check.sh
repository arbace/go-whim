...
#
# Runs after pipes/whim117-edit.sh and the sweep tools/phaserun.sh runs between them, and
...
work=${1:?usage: whim117-check.sh <work-dir> <state-dir>}
state=${2:?usage: whim117-check.sh <work-dir> <state-dir>}
