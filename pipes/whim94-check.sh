...
#
# Runs after pipes/whim94-edit.sh and the sweep tools/phaserun.sh runs between them,
...
work=${1:?usage: whim94-check.sh <work-dir> <state-dir>}
state=${2:?usage: whim94-check.sh <work-dir> <state-dir>}
