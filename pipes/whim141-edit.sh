#!/bin/sh
# Whim phase 141 -- regrepeat() does not jump into a case.  See WHIM-GOAL.md.
#
# Usage: pipes/whim141-edit.sh <work-dir> <state-dir>     (run from the repository root)
#
...
work=${1:?usage: whim141-edit.sh <work-dir> <state-dir>}
state=${2:?usage: whim141-edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
