#!/bin/sh
# Whim phase 149 -- the allocation-failure branches fold.  See WHIM-GOAL.md.
#
# Usage: pipes/whim149-edit.sh <work-dir> <state-dir>     (run from the repository root)
#
...
work=${1:?usage: whim149-edit.sh <work-dir> <state-dir>}
state=${2:?usage: whim149-edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
