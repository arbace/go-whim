...
# See pipes/whim161-edit.sh, and WHIM-GOAL.md.
#
# Usage: pipes/whim161-check.sh <work-dir> <state-dir>    (run from the repository root)
#
...
work=${1:?usage: whim161-check.sh <work-dir> <state-dir>}
state=${2:?usage: whim161-check.sh <work-dir> <state-dir>}
