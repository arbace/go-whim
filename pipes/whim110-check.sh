...
#
# Runs after pipes/whim110-edit.sh and the sweep tools/phaserun.sh runs between them, and
...
work=${1:?usage: whim110-check.sh <work-dir> <state-dir>}
state=${2:?usage: whim110-check.sh <work-dir> <state-dir>}
