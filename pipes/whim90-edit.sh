...
# tools/phasecheck.sh in pipes/whim90-check.sh is where "it compiles" is asserted.
#
...
# flags, exactly as pipes/whim85-edit.sh, whim87-edit.sh, whim88-edit.sh and
# whim89-edit.sh do it.  THE CORPUS CANNOT SEE THAT A FILE WAS READ: every one of
...
work=${1:?usage: whim90-edit.sh <work-dir> <state-dir>}
state=${2:?usage: whim90-edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs pipes/whim90-check.sh.
