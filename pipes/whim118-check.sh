...
#
# Runs after pipes/whim118-edit.sh and the sweep tools/phaserun.sh runs between them, and
...
work=${1:?usage: whim118-check.sh <work-dir> <state-dir>}
state=${2:?usage: whim118-check.sh <work-dir> <state-dir>}
