#!/bin/sh
# Whim phase 147 -- deathtrap() runs at the host's next wait.  See WHIM-GOAL.md.
#
# Usage: pipes/whim147-edit.sh <work-dir> <state-dir>     (run from the repository root)
#
...
work=${1:?usage: whim147-edit.sh <work-dir> <state-dir>}
state=${2:?usage: whim147-edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
