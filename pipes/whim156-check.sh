...
# See pipes/whim156-edit.sh, and WHIM-GOAL.md.
#
# Usage: pipes/whim156-check.sh <work-dir> <state-dir>    (run from the repository root)
#
...
work=${1:?usage: whim156-check.sh <work-dir> <state-dir>}
state=${2:?usage: whim156-check.sh <work-dir> <state-dir>}
