...
#
# Runs after pipes/whim98-edit.sh and the sweep tools/phaserun.sh runs between them,
...
work=${1:?usage: whim98-check.sh <work-dir> <state-dir>}
state=${2:?usage: whim98-check.sh <work-dir> <state-dir>}
