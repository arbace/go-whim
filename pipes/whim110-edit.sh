...
work=${1:?usage: whim110-edit.sh <work-dir> <state-dir>}
state=${2:?usage: whim110-edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs pipes/whim110-check.sh.
