...
#
# Runs after pipes/whim102-edit.sh and the sweep tools/phaserun.sh runs between them,
...
work=${1:?usage: whim102-check.sh <work-dir> <state-dir>}
state=${2:?usage: whim102-check.sh <work-dir> <state-dir>}
