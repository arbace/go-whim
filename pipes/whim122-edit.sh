...
# pipes/whim88-edit.sh takes them: the check needs the old binary to show what `-T`
...
work=${1:?usage: whim122-edit.sh <work-dir> <state-dir>}
state=${2:?usage: whim122-edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs pipes/whim122-check.sh.
