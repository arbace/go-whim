...
# See pipes/whim155-edit.sh, and WHIM-GOAL.md.
#
# Usage: pipes/whim155-check.sh <work-dir> <state-dir>    (run from the repository root)
#
...
work=${1:?usage: whim155-check.sh <work-dir> <state-dir>}
state=${2:?usage: whim155-check.sh <work-dir> <state-dir>}
