...
# See pipes/whim151-edit.sh, and WHIM-GOAL.md.
#
# Usage: pipes/whim151-check.sh <work-dir> <state-dir>    (run from the repository root)
#
...
work=${1:?usage: whim151-check.sh <work-dir> <state-dir>}
state=${2:?usage: whim151-check.sh <work-dir> <state-dir>}
