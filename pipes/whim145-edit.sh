#!/bin/sh
# Whim phase 145 -- check_termcode() has no goto.  See WHIM-GOAL.md.
#
# Usage: pipes/whim145-edit.sh <work-dir> <state-dir>     (run from the repository root)
#
...
work=${1:?usage: whim145-edit.sh <work-dir> <state-dir>}
state=${2:?usage: whim145-edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
