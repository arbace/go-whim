#!/bin/sh
# Whim phase 150 -- the regexp stack is three typed stacks.  See WHIM-GOAL.md.
#
# Usage: pipes/whim150-edit.sh <work-dir> <state-dir>     (run from the repository root)
#
...
work=${1:?usage: whim150-edit.sh <work-dir> <state-dir>}
state=${2:?usage: whim150-edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
