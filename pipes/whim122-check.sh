...
#
# Runs after pipes/whim122-edit.sh and the sweep tools/phaserun.sh runs between them,
...
work=${1:?usage: whim122-check.sh <work-dir> <state-dir>}
state=${2:?usage: whim122-check.sh <work-dir> <state-dir>}
