...
# See pipes/whim135-edit.sh, and WHIM-GOAL.md.
#
# Usage: pipes/whim135-check.sh <work-dir> <state-dir>    (run from the repository root)
#
...
work=${1:?usage: whim135-check.sh <work-dir> <state-dir>}
state=${2:?usage: whim135-check.sh <work-dir> <state-dir>}
