...
#
# Runs after pipes/whim105-edit.sh and the sweep tools/phaserun.sh runs between them, and
...
work=${1:?usage: whim105-check.sh <work-dir> <state-dir>}
state=${2:?usage: whim105-check.sh <work-dir> <state-dir>}
