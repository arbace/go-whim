#!/bin/sh
# Whim phase 157 -- get_register() and put_register() carry a yankreg_T *, not a void *.  See WHIM-GOAL.md.
#
# Usage: pipes/whim157-edit.sh <work-dir> <state-dir>     (run from the repository root)
#
...
work=${1:?usage: whim157-edit.sh <work-dir> <state-dir>}
state=${2:?usage: whim157-edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
