...
# last phase but two removed six.  pipes/whim102-check.sh builds the `sigsetjmp` variant
...
work=${1:?usage: whim102-edit.sh <work-dir> <state-dir>}
state=${2:?usage: whim102-edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs pipes/whim102-check.sh.
