...
# and `tools/phasecheck.sh` in pipes/whim89-check.sh is where "it compiles" is
...
# flags, exactly as pipes/whim85-edit.sh, whim87-edit.sh and whim88-edit.sh do it.  It
...
work=${1:?usage: whim89-edit.sh <work-dir> <state-dir>}
state=${2:?usage: whim89-edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs pipes/whim89-check.sh.
