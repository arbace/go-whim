#!/bin/sh
# Whim phase 129 -- p_emoji is an int.  See WHIM-GOAL.md.
#
# Usage: pipes/whim129-edit.sh <work-dir> <state-dir>     (run from the repository root)
#
...
work=${1:?usage: whim129-edit.sh <work-dir> <state-dir>}
state=${2:?usage: whim129-edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
