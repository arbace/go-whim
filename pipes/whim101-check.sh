...
#
# Runs after pipes/whim101-edit.sh and the sweep tools/phaserun.sh runs between them,
...
work=${1:?usage: whim101-check.sh <work-dir> <state-dir>}
state=${2:?usage: whim101-check.sh <work-dir> <state-dir>}
