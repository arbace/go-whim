...
#
# Runs after pipes/whim106-edit.sh and the sweep tools/phaserun.sh runs between them, and
...
work=${1:?usage: whim106-check.sh <work-dir> <state-dir>}
state=${2:?usage: whim106-check.sh <work-dir> <state-dir>}
