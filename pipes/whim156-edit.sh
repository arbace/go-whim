#!/bin/sh
# Whim phase 156 -- the regex size pass's node is a static byte, not (char_u *) -1.  See WHIM-GOAL.md.
#
# Usage: pipes/whim156-edit.sh <work-dir> <state-dir>     (run from the repository root)
#
...
work=${1:?usage: whim156-edit.sh <work-dir> <state-dir>}
state=${2:?usage: whim156-edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
