#!/bin/sh
# Whim phase 158 -- a highlight's terminal font is read only from a colour entry.  See WHIM-GOAL.md.
#
# Usage: pipes/whim158-edit.sh <work-dir> <state-dir>     (run from the repository root)
#
...
work=${1:?usage: whim158-edit.sh <work-dir> <state-dir>}
state=${2:?usage: whim158-edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
