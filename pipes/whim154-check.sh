...
# See pipes/whim154-edit.sh, and WHIM-GOAL.md.
#
# Usage: pipes/whim154-check.sh <work-dir> <state-dir>    (run from the repository root)
#
...
work=${1:?usage: whim154-check.sh <work-dir> <state-dir>}
state=${2:?usage: whim154-check.sh <work-dir> <state-dir>}
