...
| `patches/cc-v4-c23.patch` | the delta `internal/cc` carries from modernc.org/cc/v4 v4.29.7, kept as the record of it -- the fork itself is tracked source, not a build-time composition (`internal/cc/README.md`) |
