...
func Edit(text []byte, w io.Writer, args []string) ([]byte, error) {
	...
	lines = vimtext.SpliceLines(lines, a, b+1, w128b0)
	...
	lines = vimtext.SpliceLines(lines, aa, bb+1, fill(w128b3))
	if aa, bb, err = defn(`^ml_new_ptr\(memfile_T \*mfp\)$`); err != nil {
		return nil, err
	}
	lines = vimtext.SpliceLines(lines, aa, bb+1, fill(w128b4))
	...
	lines = vimtext.SpliceLines(lines, lo, lo, fill(w128b5))
	...
	lines = vimtext.SpliceLines(lines, a, b+1, w128b6)
	...
	lines = vimtext.SpliceLines(lines, i, b+1, w128b7)
	...
	lines = vimtext.SpliceLines(lines, i, i+1, w128b8)
