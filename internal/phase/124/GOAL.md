...
`internal/phase/124/edit.go` and `internal/phase/124/check.go`, `stage 124`, `package host`.
...
that killed it are both in `internal/phase/124/delta.md`, so the correction survives outside the git
log.
