...
`internal/phase/100/edit.go` and `internal/phase/100/check.go`, `stage 100`, `package host`. Nine
...
`internal/phase/100/check.go` instruments the source the phase was **handed** —
...
`internal/phase/100/delta.md` gets a comment and no line, and the reason is the statement. Five
