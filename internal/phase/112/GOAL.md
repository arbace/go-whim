...
`internal/phase/112/edit.go` and `internal/phase/112/check.go`, `stage 112`, `package casemap`.
...
full recordings are byte-identical in all 106 records, so `internal/phase/112/delta.md` gains no
