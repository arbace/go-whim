...
`internal/phase/121/edit.go` and `internal/phase/121/check.go`, `stage 121`, `package terminal`.
...
`internal/phase/121/delta.md` states which **eight** of the nineteen rows move and to what, because
...
the defect was a comment.** `internal/phase/121/check.go`'s header said the cut was *"whim.mk's
