...
// -- no surviving row carries that name -- and internal/phase/121/check.go proves it again
...
// format string and the name move together, as internal/phase/095/edit.go's `[RO]` did,
