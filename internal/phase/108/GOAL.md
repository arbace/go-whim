...
`internal/phase/108/edit.go` and `internal/phase/108/check.go`, `stage 108`, `package boundary`.
...
`internal/phase/102/edit.go` states it in as many words: *a pointer the launcher installs
