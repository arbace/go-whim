...
// internal/phase/118/edit.go's own three literals, EXTRACTED by an AST walk rather
...
var (
	w118Go     = []string{"void *malloc(usize n);", "void free(void *p);", "long write(int fd, const void *buf, usize n);"}
