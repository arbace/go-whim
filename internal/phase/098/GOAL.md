...
`internal/phase/098/edit.go` and `internal/phase/098/check.go`, `stage 98`, `package vendor`. Phase
...
98` finds the same against whim-vim's frozen baselines. `internal/phase/098/delta.md` gets a
comment and no line.
