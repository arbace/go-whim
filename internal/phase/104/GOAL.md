...
**Since phase 167:** `<stdio.h>` is left unused here and dropped there, with every
...
comes within 800 characters of the bound and `internal/phase/104/delta.md` is a list of records
