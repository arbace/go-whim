...
corpus's insufficiency as a requirement**: `internal/phase/125/check.go:686` requires
root-split coverage to *decrease* under phase 125's wider pointer block, and
`internal/phase/126/check.go:557` requires identical tree-event tuples across a fanout change.
