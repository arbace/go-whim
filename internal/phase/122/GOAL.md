...
`internal/phase/122/edit.go` and `internal/phase/122/check.go`, `stage 122`, `package terminal`. Zero
...
the one numbered list**, keyed to the order the kinds first appear in `internal/phase/122/delta.md`,
