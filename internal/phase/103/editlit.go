...
// Every act internal/phase/103/edit.go performs and every line it says, in SOURCE
...
// w103RealWait is the three-line RealWaitForChar the phase splices in place of
...
const w103RealWait = "RealWaitForChar(int fd __attribute__((unused)), long msec, int " +
