...
`internal/phase/085/check.go` measures the removed behaviour directly, in both directions:
...
`tools/coredelta.sh` refused without the `.reference/core-baselines` phase 83 records,
