...
func Edit(text []byte, w io.Writer, args []string) ([]byte, error) {
	...
	lines = vimtext.SpliceLines(lines, a, b+1, w127b1)
	...
	lines = vimtext.SpliceLines(lines, lo, lo, w127b2)
	...
	lines = vimtext.SpliceLines(lines, a, b+1, w127b3)
	if lo, hi, err = fn("ml_open"); err != nil {
		return nil, err
	}
	...
	lines = vimtext.SpliceLines(lines, a, b+1, w127b4)
	...
	lines = vimtext.SpliceLines(lines, a+1, a+1, w127b5)
	...
	lines = vimtext.SpliceLines(lines, a, a+1, w127b6)
	...
	lines = vimtext.SpliceLines(lines, a, stmtEnd(k)+1, w127b7)
	...
	lines = vimtext.SpliceLines(lines, a, b+1, w127b8)
	...
	lines = vimtext.SpliceLines(lines, a, b+1, w127b9)
	...
	lines = vimtext.SpliceLines(lines, a, b+1, w127b10)
	...
	for _, name := range []string{"ml_firstmarked", "ml_clearmarked"} {
		...
		lines = vimtext.SpliceLines(lines, a, b+1, w127b11)
	}
