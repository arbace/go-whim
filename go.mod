...
// tools/patches/cc-v4-c23.patch applied in place (internal/cc/README.md).  What
// is required here is what that fork needs and nothing else -- its test-only
// dependencies, ccorpus2 among them, are not carried.
require (
