...
var tools = map[string]tool{
	...
	"nosession":   {runNosession, "nosession <file>"},
	"onebuffer":   {runOnebuffer, "onebuffer <file>"},
	"nocindent":   {runNocindent, "nocindent <file>"},
	"nowildmenu":  {runNowildmenu, "nowildmenu <file>"},
	"nomouse":     {runNomouse, "nomouse <file>"},
	"notabs":      {runNotabs, "notabs <file>"},
	"nomemfile":   {runNomemfile, "nomemfile <file>"},
	"nocomplkeys": {runNocomplkeys, "nocomplkeys <file>"},
	"lfonly":      {runLfonly, "lfonly <file>"},
	"nowindows":   {runNowindows, "nowindows <file>"},
	"noconv":      {runNoconv, "noconv <file>"},
