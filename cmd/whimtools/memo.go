...
import (
	...
	"github.com/arbace/go-whim/internal/memo"
	"github.com/arbace/go-whim/internal/pipeline"
)
...
func runPhasecheck(args []string) int {
	if len(args) != 3 {
		fmt.Fprintln(os.Stderr, "usage: whimtools phasecheck <work-dir> <source> <before-dir>")
		return 1
	}
...
func runTreedigest(args []string) int {
	if len(args) != 1 {
		fmt.Fprintln(os.Stderr, "usage: whimtools treedigest <work-dir>")
		return 1
	}
...
func runRestore(args []string) int {
	if len(args) != 2 {
		fmt.Fprintln(os.Stderr, "usage: whimtools restore <in.tar> <dir>")
		return 1
	}
...
func runSnapshot(args []string) int {
	if len(args) != 3 {
		fmt.Fprintln(os.Stderr, "usage: whimtools snapshot <dir> <out.tar> <out.sha256>")
		return 1
	}
