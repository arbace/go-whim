...
**whim** (the `Makefile`, 166 phases) removes capability on purpose. **Phases 0-82** remove the runtime files, the eval layer,
...
**A phase is a function of the tree it is handed**, so the pipeline is 166 of
