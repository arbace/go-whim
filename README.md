...
```
slim-vim.c  ──────── 0-82 ────────▶  q82  ──────── 83-145 ────────▶  whim-vim.c
...
**whim** (`whim.mk`, 146 phases) removes capability on purpose, and every phase
...
numbered from 0 — zero phase N is phase N+83. **Phases 129-145** take out of
