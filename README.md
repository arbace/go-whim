...
```
slim-vim.c  ──────── 0-82 ────────▶  q82  ──────── 83-142 ────────▶  whim-vim.c
...
**whim** (`whim.mk`, 143 phases) removes capability on purpose, and every phase
...
numbered from 0 — zero phase N is phase N+83. **Phases 129-142** take out of
