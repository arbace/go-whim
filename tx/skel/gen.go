...
func (g *gen) write(dir string) error {
	...
	// writes a body against it (tx/CONVENTIONS.md).
	sigs := "Generated by tx/skel from editor.c: the Go signature of every function\n" +
		"the transpilation writes.  Copy the one you need (tx/CONVENTIONS.md).\n\n" +
