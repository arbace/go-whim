...
func (g *gen) write(dir string) error {
	...
	var b strings.Builder
	b.WriteString("// Code generated by tx/skel from editor.c: the types of the transpilation.\n\npackage main\n\n")
	...
	b.WriteString(")\n")
	if err := os.WriteFile(filepath.Join(dir, "types.go"), []byte(b.String()), 0o644); err != nil {
		return err
	}
	b.Reset()
	b.WriteString("// Code generated by tx/skel from editor.c: every file-scope object and every\n// block-scope static, hoisted as <function>_<name>, with its type and no initializer.\n\npackage main\n\n")
	for _, l := range dedupe(g.globals) {
		b.WriteString(l + "\n")
	}
	if err := os.WriteFile(filepath.Join(dir, "globals.go"), []byte(b.String()), 0o644); err != nil {
		return err
	}
