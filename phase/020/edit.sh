#!/bin/sh
# Whim phase 20 -- nothing outside the process is consulted.  See GOAL.md.
#
# Usage: phase/020/edit.sh <work-dir> <state-dir>      (run from the repository root)
#
...
work=${1:?usage: phase/020/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs phase/020/check.sh.
