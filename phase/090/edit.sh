...
#
# Usage: phase/090/edit.sh <work-dir> <state-dir>      (run from the repository root)
#
...
# tools/phasecheck.sh in phase/090/check.sh is where "it compiles" is asserted.
#
...
# flags, exactly as phase/085/edit.sh, phase/087/edit.sh, phase/088/edit.sh and
# phase/089/edit.sh do it.  THE CORPUS CANNOT SEE THAT A FILE WAS READ: every one of
...
work=${1:?usage: phase/090/edit.sh <work-dir> <state-dir>}
state=${2:?usage: phase/090/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs phase/090/check.sh.
