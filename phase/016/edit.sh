#!/bin/sh
# Whim phase 16 -- six options that no longer decide anything.  See GOAL.md.
#
# Usage: phase/016/edit.sh <work-dir> <state-dir>      (run from the repository root)
#
...
work=${1:?usage: phase/016/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs phase/016/check.sh.
