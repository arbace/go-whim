...
#
# Usage: phase/109/edit.sh <work-dir> <state-dir>     (run from the repository root)
#
...
work=${1:?usage: phase/109/edit.sh <work-dir> <state-dir>}
state=${2:?usage: phase/109/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
tools/st.sh edit whim109 "$f" "$state/minmax.txt"
...
# tools/phaserun.sh sweeps next, then runs phase/109/check.sh.
