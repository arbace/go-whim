#!/bin/sh
# Whim phase 53 -- no conversion layer, no 'encoding'.  See GOAL.md.
#
# Usage: phase/053/edit.sh <work-dir> <state-dir>      (run from the repository root)
#
...
work=${1:?usage: phase/053/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs phase/053/check.sh.
