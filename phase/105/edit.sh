...
#
# Usage: phase/105/edit.sh <work-dir> <state-dir>     (run from the repository root)
#
...
#   build would not, and phase/105/check.sh makes it.
#
...
work=${1:?usage: phase/105/edit.sh <work-dir> <state-dir>}
state=${2:?usage: phase/105/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
