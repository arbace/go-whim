#!/bin/sh
# Whim phase 40 -- no window sizes to set.  See GOAL.md.
#
# Usage: phase/040/edit.sh <work-dir> <state-dir>      (run from the repository root)
#
...
work=${1:?usage: phase/040/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs phase/040/check.sh.
