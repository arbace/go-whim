#!/bin/sh
# Whim phase 11 -- nothing is written that was not asked for.  See GOAL.md.
#
# Usage: phase/011/edit.sh <work-dir> <state-dir>      (run from the repository root)
#
...
work=${1:?usage: phase/011/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs phase/011/check.sh.
