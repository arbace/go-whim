#!/bin/sh
# Whim phase 17 -- the last two per-buffer encoding options.  See GOAL.md.
#
# Usage: phase/017/edit.sh <work-dir> <state-dir>      (run from the repository root)
#
...
work=${1:?usage: phase/017/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs phase/017/check.sh.
