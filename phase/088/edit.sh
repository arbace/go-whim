...
#
# Usage: phase/088/edit.sh <work-dir> <state-dir>      (run from the repository root)
#
...
# both, and phase/088/check.sh compares the DWARF enumerator values of the binary
...
# flags, exactly as phase/085/edit.sh and phase/087/edit.sh do it: the check
...
work=${1:?usage: phase/088/edit.sh <work-dir> <state-dir>}
state=${2:?usage: phase/088/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs phase/088/check.sh.
