...
#
# Usage: phase/102/edit.sh <work-dir> <state-dir>     (run from the repository root)
#
...
# last phase but two removed six.  phase/102/check.sh builds the `sigsetjmp` variant
...
work=${1:?usage: phase/102/edit.sh <work-dir> <state-dir>}
state=${2:?usage: phase/102/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs phase/102/check.sh.
