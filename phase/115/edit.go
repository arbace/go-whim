...
// See GOALS.md II.4c, GOALS.md, phase/109/edit.go (which wrote the core's libc
// prototypes) and phase/111/edit.go (the scalar clock, whose musl_now_ms is this
// phase's sibling).
//
...
//
// below the includes, beside the twelve.  phase/115/check.go measures that it holds
...
// core -> host signature takes scalars and byte buffers only (phase/111/check.go),
...
// or when.  phase/115/check.go instruments every clock read on BOTH binaries and
