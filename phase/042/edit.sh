#!/bin/sh
# Whim phase 42 -- one buffer, always.  See GOAL.md.
#
# Usage: phase/042/edit.sh <work-dir> <state-dir>      (run from the repository root)
#
...
work=${1:?usage: phase/042/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs phase/042/check.sh.
