...
# See GOAL.md.
#
# Usage: phase/065/edit.sh <work-dir> <state-dir>      (run from the repository root)
#
...
work=${1:?usage: phase/065/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"

tools/st.sh edit whim65 "$f"

# tools/phaserun.sh sweeps next, then runs phase/065/check.sh.
