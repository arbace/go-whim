#!/bin/sh
# Whim phase 125 -- the swap file's residue.  See GOAL.md and GOALS.md II.4a.
#
# Usage: phase/125/edit.sh <work-dir> <state-dir>     (run from the repository root)
#
# THE FILESYSTEM WENT AT PHASES 89 TO 93 AND THE SWAP FILE'S MACHINERY DID NOT.  memline
...
work=${1:?usage: phase/125/edit.sh <work-dir> <state-dir>}
state=${2:?usage: phase/125/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
tools/st.sh edit whim125 "$f" "$state"
