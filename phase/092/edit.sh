...
# See GOAL.md.
#
# Usage: phase/092/edit.sh <work-dir> <state-dir>      (run from the repository root)
#
...
# because it IS that, no behavioural probe can see it.  phase/092/check.sh says
...
# flags, exactly as phase/085/edit.sh and whim87- through phase/091/edit.sh do it, and
...
work=${1:?usage: phase/092/edit.sh <work-dir> <state-dir>}
state=${2:?usage: phase/092/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs phase/092/check.sh.
