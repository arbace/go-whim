...
# See GOAL.md.
#
# Usage: phase/013/edit.sh <work-dir> <state-dir>      (run from the repository root)
#
...
work=${1:?usage: phase/013/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"

# --- cut the entry points -------------------------------------------------
tools/st.sh nostat "$f"

# tools/phaserun.sh sweeps next, then runs phase/013/check.sh.
