...
# See phase/133/edit.sh, and GOALS.md.
#
# Usage: phase/133/check.sh <work-dir> <state-dir>    (run from the repository root)
#
...
work=${1:?usage: phase/133/check.sh <work-dir> <state-dir>}
state=${2:?usage: phase/133/check.sh <work-dir> <state-dir>}
