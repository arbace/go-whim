#!/bin/sh
# Whim phase 35 -- no scripts, no session, no autocommands.  See GOAL.md.
#
# Usage: phase/035/edit.sh <work-dir> <state-dir>      (run from the repository root)
#
...
work=${1:?usage: phase/035/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs phase/035/check.sh.
