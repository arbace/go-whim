#!/bin/sh
# Whim phase 49 -- one set of options.  See GOAL.md.
#
# Usage: phase/049/edit.sh <work-dir> <state-dir>      (run from the repository root)
#
...
work=${1:?usage: phase/049/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs phase/049/check.sh.
