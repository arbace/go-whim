...
#
# Usage: phase/085/edit.sh <work-dir> <state-dir>      (run from the repository root)
#
...
# not evidence, so phase/085/check.sh measures the removed behaviour directly, in
...
work=${1:?usage: phase/085/edit.sh <work-dir> <state-dir>}
state=${2:?usage: phase/085/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs phase/085/check.sh.
