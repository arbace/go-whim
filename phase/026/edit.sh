#!/bin/sh
# Whim phase 26 -- five signals, not twenty-one.  See GOAL.md.
#
# Usage: phase/026/edit.sh <work-dir> <state-dir>      (run from the repository root)
#
...
work=${1:?usage: phase/026/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"

# --- cut the entry points -------------------------------------------------
tools/st.sh nosignals "$f"

# tools/phaserun.sh sweeps next, then runs phase/026/check.sh.
