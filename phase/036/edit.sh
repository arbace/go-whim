#!/bin/sh
# Whim phase 36 -- one tab page, always.  See GOAL.md.
#
# Usage: phase/036/edit.sh <work-dir> <state-dir>      (run from the repository root)
#
...
work=${1:?usage: phase/036/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs phase/036/check.sh.
