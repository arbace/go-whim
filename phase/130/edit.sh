...
#
# Usage: phase/130/edit.sh <work-dir> <state-dir>     (run from the repository root)
#
...
work=${1:?usage: phase/130/edit.sh <work-dir> <state-dir>}
state=${2:?usage: phase/130/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
