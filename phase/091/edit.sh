...
# See GOAL.md.
#
# Usage: phase/091/edit.sh <work-dir> <state-dir>      (run from the repository root)
#
...
# tools/phasecheck.sh in phase/091/check.sh is where "it compiles" is asserted.
#
...
# flags, exactly as phase/085/edit.sh, phase/087/edit.sh, phase/088/edit.sh, phase/089/edit.sh
# and phase/090/edit.sh do it.  THE CORPUS SEES TWO CASES OF THIS PHASE and neither of
...
work=${1:?usage: phase/091/edit.sh <work-dir> <state-dir>}
state=${2:?usage: phase/091/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs phase/091/check.sh.
