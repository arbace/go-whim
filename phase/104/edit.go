...
// in this editor is built in -- and phase/104/check.go pins both halves of it, the
...
// remaining step and not this one.  What IS assertable, and what phase/104/check.go
