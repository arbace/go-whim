...
# See GOALS.md II.4c, GOALS.md, and phase/109/edit.sh, which created the thing
# this phase retires.
#
# Usage: phase/111/edit.sh <work-dir> <state-dir>     (run from the repository root)
#
...
work=${1:?usage: phase/111/edit.sh <work-dir> <state-dir>}
state=${2:?usage: phase/111/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs phase/111/check.sh.
