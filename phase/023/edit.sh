#!/bin/sh
# Whim phase 23 -- no floating-point library.  See GOAL.md.
#
# Usage: phase/023/edit.sh <work-dir> <state-dir>      (run from the repository root)
#
...
work=${1:?usage: phase/023/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs phase/023/check.sh.
