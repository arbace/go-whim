...
#
# Usage: phase/128/edit.sh <work-dir> <state-dir>     (run from the repository root)
#
...
work=${1:?usage: phase/128/edit.sh <work-dir> <state-dir>}
state=${2:?usage: phase/128/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
tools/st.sh edit whim128 "$f" "$state"
...
# tools/phaserun.sh sweeps next, then runs phase/128/check.sh.
