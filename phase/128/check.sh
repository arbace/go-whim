...
#
# Usage: phase/128/check.sh <work-dir> <state-dir>   (run from the repository root)
#
...
work=${1:?usage: phase/128/check.sh <work-dir> <state-dir>}
state=${2:?usage: phase/128/check.sh <work-dir> <state-dir>}
exec tools/st.sh check whim128 "$work" "$state"
