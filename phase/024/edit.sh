#!/bin/sh
# Whim phase 24 -- there is no mouse.  See GOAL.md.
#
# Usage: phase/024/edit.sh <work-dir> <state-dir>      (run from the repository root)
#
...
work=${1:?usage: phase/024/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs phase/024/check.sh.
