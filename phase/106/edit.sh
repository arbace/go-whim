...
#
# Usage: phase/106/edit.sh <work-dir> <state-dir>     (run from the repository root)
#
...
# nobody expected it on, and phase/106/check.sh builds the literal-unaware form as a
...
work=${1:?usage: phase/106/edit.sh <work-dir> <state-dir>}
state=${2:?usage: phase/106/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs phase/106/check.sh.
