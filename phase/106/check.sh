...
# See phase/106/edit.sh, and GOALS.md II.4c.
#
# Usage: phase/106/check.sh <work-dir> <state-dir>    (run from the repository root)
#
# Runs after phase/106/edit.sh and the sweep tools/phaserun.sh runs between them, and
...
state=${2:?usage: phase/106/check.sh <work-dir> <state-dir>}
exec tools/st.sh check whim106 "$work" "$state"
