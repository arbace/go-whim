#!/bin/sh
# Whim phase 10 -- no tag stack.  See GOAL.md.
#
# Usage: phase/010/edit.sh <work-dir> <state-dir>      (run from the repository root)
#
...
work=${1:?usage: phase/010/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs phase/010/check.sh.
