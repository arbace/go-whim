...
#
# Usage: phase/113/edit.sh <work-dir> <state-dir>     (run from the repository root)
#
...
# it fire.  phase/113/check.sh has all three -- the input built twice with
...
#    follow-up beside `msg_puts_printf()`.  phase/104/check.sh says the two "fire in
...
work=${1:?usage: phase/113/edit.sh <work-dir> <state-dir>}
state=${2:?usage: phase/113/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs phase/113/check.sh.
