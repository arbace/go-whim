...
#
# Usage: phase/089/edit.sh <work-dir> <state-dir>      (run from the repository root)
#
...
# and `tools/phasecheck.sh` in phase/089/check.sh is where "it compiles" is
...
# flags, exactly as phase/085/edit.sh, phase/087/edit.sh and phase/088/edit.sh do it.  It
...
work=${1:?usage: phase/089/edit.sh <work-dir> <state-dir>}
state=${2:?usage: phase/089/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs phase/089/check.sh.
