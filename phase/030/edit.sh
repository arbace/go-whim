#!/bin/sh
# Whim phase 30 -- K and the tag jumps, keeping * and #.  See GOAL.md.
#
# Usage: phase/030/edit.sh <work-dir> <state-dir>      (run from the repository root)
#
...
work=${1:?usage: phase/030/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"

# --- cut the entry points -------------------------------------------------
tools/st.sh noident "$f"

# tools/phaserun.sh sweeps next, then runs phase/030/check.sh.
