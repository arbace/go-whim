#!/bin/sh
# Whim phase 14 -- a file name means the file of that name.  See GOAL.md.
#
# Usage: phase/014/edit.sh <work-dir> <state-dir>      (run from the repository root)
#
...
work=${1:?usage: phase/014/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs phase/014/check.sh.
