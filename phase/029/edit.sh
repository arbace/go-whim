#!/bin/sh
# Whim phase 29 -- :command, user-defined commands.  See GOAL.md.
#
# Usage: phase/029/edit.sh <work-dir> <state-dir>      (run from the repository root)
#
...
work=${1:?usage: phase/029/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs phase/029/check.sh.
