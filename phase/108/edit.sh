...
#
# Usage: phase/108/edit.sh <work-dir> <state-dir>     (run from the repository root)
#
...
# through a parameter of `vim_main()` that `main()` passes.  phase/102/edit.sh says
...
# it must print `main` alone.  phase/108/check.sh builds both variants.
#
...
work=${1:?usage: phase/108/edit.sh <work-dir> <state-dir>}
state=${2:?usage: phase/108/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs phase/108/check.sh.
