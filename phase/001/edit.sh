#!/bin/sh
# Whim phase 1 -- no $VIMRUNTIME.  See GOAL.md.
#
# Usage: phase/001/edit.sh <work-dir> <state-dir>       (run from the repository root)
#
...
work=${1:?usage: phase/001/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs phase/001/check.sh.
