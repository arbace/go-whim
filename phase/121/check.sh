...
# See phase/121/edit.sh, and GOALS.md.
#
# Usage: phase/121/check.sh <work-dir> <state-dir>   (run from the repository root)
#
# Runs after phase/121/edit.sh and the sweep tools/phaserun.sh runs between them,
...
work=${1:?usage: phase/121/check.sh <work-dir> <state-dir>}
state=${2:?usage: phase/121/check.sh <work-dir> <state-dir>}
exec tools/st.sh check whim121 "$work" "$state"
