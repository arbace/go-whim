...
#
# Usage: phase/094/edit.sh <work-dir> <state-dir>     (run from the repository root)
#
...
#      to take -- exactly as phase/090/edit.sh says of its own, and that is stated
...
work=${1:?usage: phase/094/edit.sh <work-dir> <state-dir>}
state=${2:?usage: phase/094/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs phase/094/check.sh.
