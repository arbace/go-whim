...
// to take -- exactly as phase/090/edit.go says of its own, and that is stated
...
func Edit(text []byte, w io.Writer) ([]byte, error) {
	...
	for _, name := range edit.SortedKeys(z11Before) {
	...
	for _, name := range edit.SortedKeys(z11After) {
