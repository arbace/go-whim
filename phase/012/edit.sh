#!/bin/sh
# Whim phase 12 -- UTF-8, and no other encoding, ever.  See GOAL.md.
#
# Usage: phase/012/edit.sh <work-dir> <state-dir>      (run from the repository root)
#
...
work=${1:?usage: phase/012/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs phase/012/check.sh.
