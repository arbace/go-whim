...
#
# Usage: phase/086/make.sh <work-dir>       (run from the repository root)
#
...
# THE BODY IS GO: internal/check/whim86.go, run through tools/st.sh.
...
work=${1:?usage: phase/086/make.sh <work-dir>}
exec tools/st.sh check whim86 "$work"
