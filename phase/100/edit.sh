...
#
# Usage: phase/100/edit.sh <work-dir> <state-dir>     (run from the repository root)
#
...
# mask and the two-row table, and phase/100/check.sh measures exactly that: the same
...
work=${1:?usage: phase/100/edit.sh <work-dir> <state-dir>}
state=${2:?usage: phase/100/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
# tools/phaserun.sh sweeps next, then runs phase/100/check.sh.
