...
#
# Usage: phase/124/edit.sh <work-dir> <state-dir>     (run from the repository root)
#
...
work=${1:?usage: phase/124/edit.sh <work-dir> <state-dir>}
state=${2:?usage: phase/124/edit.sh <work-dir> <state-dir>}
f="$work/whim-vim.c"
...
tools/st.sh edit whim124 "$f" "$state"
...
# tools/phaserun.sh sweeps next, then runs phase/124/check.sh.
